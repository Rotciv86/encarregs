...
import {CosaDemanada} from '../models/cosa-demanada.model';
import {CosaDemanadaRepository} from '../repositories/cosa-demanada.repository';

export class CosaDemanadaController {
  constructor(
