...
import {DetallDeLEncarreg} from '../models/detall-de-l-encarreg.model';
import {DetallDeLEncarregRepository} from '../repositories/detall-de-l-encarreg.repository';

export class DetallDeLEngarregController {
  constructor(
